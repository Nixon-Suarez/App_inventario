...
<div class="container pb-6 pt-6">
	...
	<form action="/php/index.php/completo/AplicacionInventario/php/usuario_guardar.php" method="POST" autocomplete="off" class="FormularioAjax" data-form="save" enctype="multipart/form-data">
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Nombres</label>
				  	<input class="input" type="text" name="usuario_nombre" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,40}" maxlength="40" required > <!--required: hace que el campo sea obligatorio-->
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
