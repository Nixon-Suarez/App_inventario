<?php
	...
	$id = (isset($_GET['category_id_up']) && $_GET['category_id_up'] > 0) ? $_GET['category_id_up'] : 0;
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Ubicación</label>
				  	<input class="input" type="text" name="categoria_ubicacion" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{5,150}" maxlength="150" value="<?php echo $datos['categoria_ubicacion']?>" required>
				</div>
		  	</div>
		</div>
